...
<p>
    <img alt="Manual Version v0.4" src="https://img.shields.io/badge/Manual-v0.4-F59E0B?style=for-the-badge">
</p>

</div>

> This document covers every apiSchema key, its purpose, accepted values, defaults, and what happens when it is missing. v0.4 adds a complete **Error Reference** covering every error response the GAPI and CCS endpoints can return, plus a guide to common apiSchema mistakes and their consequences.
...
| `404` | `"Record not found."` | No row with that `id` exists | Verify the `id` |
